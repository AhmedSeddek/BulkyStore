...
namespace BulkyStore.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class CartController : Controller
    {
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            try
            {
                var msg = MessageResource.Create(
                        body: "Order placed on bulkystore . your order id :" + id,
        ...
        //    ModelState.AddModelError(string.Empty, "verification email is sen , check your mailbox!");

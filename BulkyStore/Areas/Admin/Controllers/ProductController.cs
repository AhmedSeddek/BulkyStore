...
namespace BulkyStore.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        {
            IEnumerable<CategoryModel> CatList = await _unitOfWork.Category.GetAllAsync(); 
        ...
        public async Task<IActionResult> Upsert(ProductVM productVM)
        {
            if (ModelState.IsValid)
            {
                ...
                if (files.Count > 0)
                {
                    ...
                    {
                        // editing so remove old image
                        var imagePath = Path.Combine(webRootPath, productVM.Product.ImageUrl
                            .TrimStart('\\'));
                ...
                else
                {
                    ...
                    {
                        ProductModel objFromDb = _unitOfWork.Product.Get(productVM.Product.Id);
